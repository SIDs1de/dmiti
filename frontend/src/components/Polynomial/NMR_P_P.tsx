...
export const NMR_P_P = () => {
  ...
  const [result, setResult] = useState<PolynomialNmrPPResponse | null>(null);
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.polynomialNmrPP({
        polynomial: poly,
      });
