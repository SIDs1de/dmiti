...
export const SUB_QQ_Q = () => {
  ...
  const [result, setResult] = useState<RationalSubQQQResponse | null>(null);
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.rationalSubQQQ({
        a: {
          numerator: {
  ...
  return (
    <section>
      <Typography.Title level={2}>SUB_QQ_Q: Вычитание дробей</Typography.Title>
      <label>
