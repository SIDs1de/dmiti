...
export const ADD_QQ_Q = () => {
  ...
  const [result, setResult] = useState<RationalAddQQQResponse | null>(null);
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.rationalAddQQQ({
        a: {
          numerator: {
  ...
  return (
    <section>
      <Typography.Title level={2}>ADD_QQ_Q: Сложение дробей</Typography.Title>
      <label>
