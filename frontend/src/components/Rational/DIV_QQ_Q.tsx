...
export const DIV_QQ_Q = () => {
  ...
  const [result, setResult] = useState<RationalDivQQQResponse | null>(null);
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.rationalDivQQQ({
        a: {
          numerator: {
