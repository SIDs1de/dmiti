...
export const MUL_ZZ_Z = () => {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.integerMulZZZ({
        a: {
  ...
  return (
    <section>
      <Typography.Title level={2}>MUL_ZZ_Z: Умножение целых чисел</Typography.Title>
      <label>
