...
export const ADD_ZZ_Z = () => {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      const response = await algebraApi.integerAddZZZ({
        a: {
  ...
  return (
    <section>
      <Typography.Title level={2}>ADD_ZZ_Z: Сложение целых чисел</Typography.Title>
      <label>
