...
export const MOD_ZZ_Z = () => {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      if (+secondNumber === 0) {
        throw new Error("Второе число не должно быть нулём");
      }
      const response = await algebraApi.integerModZZZ({
        a: {
